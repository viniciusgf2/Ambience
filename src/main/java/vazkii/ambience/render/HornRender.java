...
public class HornRender {
	...
	public static void drawBoundingBox(Vector3d pos, float partial_ticks, RenderWorldLastEvent event,World worldIn, PlayerEntity playerIn) {
	...
	private static void drawLines(Matrix4f matrix, IVertexBuilder buffer, Vector3d pos, Vector4f color, Vector4f color2) {
		count += 0.01f;
		radius = 1f;
