...
public class CreateAreaScreen extends ContainerScreen<GuiContainerMod> {
	...
	private static final ResourceLocation textureBackground = new ResourceLocation(
	...
	public void render(final int mouseX, final int mouseY, final float partialTicks) {
		...
		if (this.AreaName == null) {
			this.AreaName = new TextFieldWidget(this.font, this.width / 2 - 80, this.height / 4 + 15, 160, 20, "");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.drawCenteredString(this.font, this.title.getFormattedText(), this.xSize / 2, this.ySize / 2 - 80,
				16777215);
		this.drawCenteredString(this.font, I18n.format("GUI.AreaNameField") + ":", this.xSize / 2 - 68,
				this.ySize / 2 - 54, 16777215);
	}
