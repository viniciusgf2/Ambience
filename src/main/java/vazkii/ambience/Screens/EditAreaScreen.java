...
public class EditAreaScreen extends ContainerScreen<EditAreaContainer> {
	...
	public void render(final int mouseX, final int mouseY, final float partialTicks) {
		...
		if (this.list == null) {
			...
			this.instaPlayChk = new CheckboxButton(this.width / 2 - 80, this.height / 4 + 50, 20, 20,I18n.format("GUI.InstantPlayChk"), currentArea.isInstantPlay());
			this.PlayatNight = new CheckboxButton(this.width / 2 - 80, this.height / 4 + 80, 20, 20,I18n.format("GUI.PlayAtNight"), currentArea.isPlayatNight());
		}
	...
	/*	this.AreaName.x = this.width / 2 - 80;
		...
		this.drawCenteredString(this.font, I18n.format("GUI.EditArea"), this.width / 2-86, this.height / 2 -88,16777215);
