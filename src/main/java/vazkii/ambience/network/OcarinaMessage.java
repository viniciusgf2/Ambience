							...
							for (Entity entity : entities) {
								if (entity instanceof HorseEntity) {
									...
									if (horse.getOwnerUniqueId().equals(player.getUniqueID())) {
										...
										Ocarina.horseName=horse.getName().getUnformattedComponentText();
										...
										Vector3d vector = new Vector3d(pos.getX()+dirX, 256, pos.getZ()+dirZ);
										BlockRayTraceResult rayTraceResult = player.world
												.rayTraceBlocks(new RayTraceContext(vector, vector.add(new Vector3d(0, 1, 0).scale(-256)),
